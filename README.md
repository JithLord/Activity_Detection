# Activity_Detection
This repository uses tensorflow to train on 4268 Non copyrighted images obtained after scraping to classify into 6 different categories Sitting, Standing, Walking, Walking on Stairs and Control.
